...
var getUniversities = function () { return __awaiter(void 0, void 0, void 0, function () {
    var response;
...
var data = function () { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, getUniversities()];
            case 1: return [2 /*return*/, _a.sent()];
        }
    });
}); };
data().then(function (response) {
    return response.map(function (university) { return console.log(university.name); });
});
